...
public class TestFechas {
	 ...
	 public static void main(String[] args) {
	        ...
	        System.out.println("Test del método of:");
	        ...
	        System.out.println("Test del método parse:");
	        ...
	        System.out.println("Fecha creada con parse: " + fecha6.año + "-" + fecha6.mes + "-" + fecha6.dia);
		        ...
		        //Apartado E
		        System.out.println("---------------------------");
		        System.out.println("Test restarDiasFechaDada");
		        Fecha fecha3 = new Fecha(2024, 3, 21);
		        System.out.println("Resultado restarDiasFechaDada:"+Fecha.restarDiasFechaDada(fecha3,0));
		        System.out.println("Resultado restarDiasFechaDada:"+Fecha.restarDiasFechaDada(fecha3,12));
		        System.out.println("Resultado restarDiasFechaDada:"+Fecha.restarDiasFechaDada(fecha3,1000));
		 }
